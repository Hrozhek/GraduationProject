...
public class Analyzer {
    ...
    private static final int SIZE_CAP = 300;
    ...
    private double calcDistance(BufferedImage bx, BufferedImage by) {
     ...
     */
    private BufferedImage rescale(BufferedImage img, int targetWidth, int targetHeight,
